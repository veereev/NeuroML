...
<!--
    ...
    This file is used to convert v1.2 ChannelML files to a "neuroscientist friendly" view
...
<table frame="box" rules="all" align="centre" cellpadding="4" width ="100%">
    <xsl:call-template name="tableRow">
        ...
        <xsl:with-param name="value"><xsl:value-of select="/cml:channelml/meta:notes"/></xsl:with-param>
     </xsl:call-template>
</table>
</xsl:if>
...
<table frame="box" rules="all" align="centre" cellpadding="4" width ="100%">
    <xsl:call-template name="tableRow">
        ...
        <xsl:with-param name="value"><xsl:value-of select="$xmlFileUnitSystem"/></xsl:with-param>
     </xsl:call-template>
</table>
...
<xsl:if test="count(cml:current_voltage_relation/cml:ohmic) &gt; 0">
    ...
    <xsl:call-template name="tableRow">
        ...
        <xsl:with-param name="value">Ohmic</xsl:with-param>
    </xsl:call-template>
   ...
   <xsl:variable name="ionname"><xsl:value-of select="cml:current_voltage_relation/cml:ohmic/@ion"/></xsl:variable>   
    ...
    <xsl:call-template name="tableRow">
        ...
        <xsl:with-param name="value"><xsl:value-of select="$ionname"/> (E<xsl:value-of 
        select="$ionname"/> = <xsl:value-of select="/cml:channelml/cml:ion[string(@name) = string($ionname)]/@default_erev"/><xsl:call-template name="getUnits">
            <xsl:with-param name="quantity">Voltage</xsl:with-param></xsl:call-template>)</xsl:with-param>
    </xsl:call-template>
    ...
    <xsl:if test="count(cml:current_voltage_relation/cml:ohmic/cml:conductance) &gt; 0">
        <xsl:call-template name="tableRow">
            ...
            <xsl:with-param name="value">Gmax = <xsl:value-of select="cml:current_voltage_relation/cml:ohmic/cml:conductance/@default_gmax"/> <xsl:call-template name="getUnits">
                <xsl:with-param name="quantity">Conductance Density</xsl:with-param></xsl:call-template></xsl:with-param>
        </xsl:call-template>
            ...
            <xsl:when test="count(cml:current_voltage_relation/cml:ohmic/cml:conductance/cml:rate_adjustments/cml:q10_settings) &gt; 0">
                ...
                <xsl:call-template name="tableRow">
                    ...
                    <xsl:with-param name="value"><xsl:value-of 
                            select="cml:current_voltage_relation/cml:ohmic/cml:conductance/cml:rate_adjustments/cml:q10_settings/@q10_factor"/></xsl:with-param>
                </xsl:call-template>
                <xsl:call-template name="tableRow">
                    ...
                    <xsl:with-param name="value"><xsl:value-of 
                        select="cml:current_voltage_relation/cml:ohmic/cml:conductance/cml:rate_adjustments/cml:q10_settings/@experimental_temp"/></xsl:with-param>
                </xsl:call-template>
                <xsl:call-template name="tableRow">
                    ...
                    <xsl:with-param name="value">tau(T) = tauExp / <xsl:value-of select="cml:current_voltage_relation/cml:ohmic/cml:conductance/cml:rate_adjustments/cml:q10_settings/@q10_factor"
    />^((T - <xsl:value-of select="cml:current_voltage_relation/cml:ohmic/cml:conductance/cml:rate_adjustments/cml:q10_settings/@experimental_temp"/>)/10)</xsl:with-param>
                </xsl:call-template>
            </xsl:when>
            <xsl:otherwise>
               <!-- <xsl:call-template name="tableRow">
        ...
        <xsl:if test="count(cml:current_voltage_relation/cml:ohmic/cml:conductance/cml:rate_adjustments/cml:offset) &gt; 0">
            <xsl:call-template name="tableRow">
                ...
                <xsl:with-param name="value"><xsl:value-of select="cml:current_voltage_relation/cml:ohmic/cml:conductance/cml:rate_adjustments/cml:offset/@value"/> <xsl:call-template name="getUnits">
        <xsl:with-param name="quantity">Voltage</xsl:with-param></xsl:call-template></xsl:with-param>
            </xsl:call-template>
        </xsl:if>
        ...
        <xsl:call-template name="tableRow">
            ...
            <xsl:with-param name="value">G<xsl:value-of select="$ionname"/>(v,t) = Gmax
                <xsl:for-each select="cml:current_voltage_relation/cml:ohmic/cml:conductance/cml:gate">
                    ...
                    <xsl:if test="number(@power) !=1">&lt;sup&gt;<xsl:value-of select="@power"/>&lt;/sup&gt;</xsl:if></xsl:for-each>
            </xsl:with-param>
        </xsl:call-template>
        ...
        <xsl:call-template name="tableRow">
            ...
            <xsl:with-param name="value">I<xsl:value-of select="$ionname"/>(v,t) = G<xsl:value-of select="$ionname"/>(v,t)<xsl:text> * </xsl:text>(v - E<xsl:value-of select="$ionname"/>)</xsl:with-param>
        </xsl:call-template>
...
<br/>
        ...
        <table frame="box" rules="all" align="centre" cellpadding="4" width ="100%">
            ...
            <xsl:call-template name="tableRow">
                ...
                <xsl:with-param name="value"><xsl:value-of select="@power"/></xsl:with-param>
            </xsl:call-template>
            ...
            <xsl:call-template name="tableRow">
                ...
                <xsl:with-param name="value">Simple Hodgkin Huxley single state transition</xsl:with-param>
            </xsl:call-template>
...
<xsl:template match="cml:table_settings">
        ...
        <xsl:call-template name="tableRow">
            ...
            <xsl:with-param name="value">Number of table divisions: <xsl:value-of select="@table_divisions"/>&lt;br/&gt;
            Maximum voltage for tables: <xsl:value-of select="@max_v"/> <xsl:call-template name="getUnits">
               <xsl:with-param name="quantity">Voltage</xsl:with-param></xsl:call-template>&lt;br/&gt;
            Minimum voltage for tables: <xsl:value-of select="@min_v"/> <xsl:call-template name="getUnits">
               <xsl:with-param name="quantity">Voltage</xsl:with-param></xsl:call-template>&lt;br/&gt;</xsl:with-param>
        </xsl:call-template> 
</xsl:template>
                ...
                <xsl:if test="count(cml:alpha) &gt; 0 and
                    ...
                    <xsl:call-template name="tableRow">
                        ...
                        <xsl:with-param name="value">
                            ...
                            select="$stateName"/>) - beta(v) * <xsl:value-of select="$stateName"/>
                            &lt;/td&gt;                                
                            &lt;/tr&gt;
                            &lt;tr&gt;
                    ...
                    <xsl:choose>
                        <xsl:when  test="name()='conc_dependence'">
                            <xsl:call-template name="tableRow">
                                ...
                                <xsl:with-param name="value">Name: <xsl:value-of select="@name"/>&lt;br/&gt;
                                    Ion: <xsl:value-of select="@ion"/>&lt;br/&gt;
                                    Variable as used in equation: <xsl:value-of select="@variable_name"/>&lt;br/&gt;
                                    Minimum concentraton: <xsl:value-of select="@min_conc"/>&lt;br/&gt;
                                    Maximum concentration: <xsl:value-of select="@max_conc"/>
                                </xsl:with-param>
                            </xsl:call-template>
                        </xsl:when>
                        <xsl:otherwise>
                            <xsl:choose>
                                <xsl:when  test="count(cml:parameterised_hh) &gt; 0">
                                    <xsl:call-template name="tableRow">
                                        ...
                                        <xsl:with-param name="value">Parameterised HH</xsl:with-param>
                                    </xsl:call-template>
                                    <xsl:call-template name="tableRow">
                                        <xsl:with-param name="name">Expression</xsl:with-param>
                                        <xsl:with-param name="value"><xsl:value-of select="name()"/>(v) = <xsl:value-of select="cml:parameterised_hh/@expr" /> &amp;nbsp;&amp;nbsp; &lt;i&gt;(<xsl:value-of select="cml:parameterised_hh/@type" />)&lt;/i&gt;</xsl:with-param>
                                    </xsl:call-template>
                                    ...
                                    <xsl:call-template name="tableRow">
                                        ...
                                        <xsl:with-param name="value">               
                                            <xsl:for-each select="cml:parameterised_hh/cml:parameter">
                                                ...
                                                <xsl:with-param name="quantity">Voltage</xsl:with-param></xsl:call-template></xsl:if>  
                                ...
                                <xsl:when  test="count(cml:generic_equation_hh) &gt; 0">
                                    <xsl:call-template name="tableRow">
                                        <xsl:with-param name="name">Form of rate equation for <xsl:value-of select="name()"/></xsl:with-param>
                                        <xsl:with-param name="value">Generic equation</xsl:with-param>
                                    </xsl:call-template> 
                                    <xsl:call-template name="tableRow">
                                        <xsl:with-param name="name">Expression</xsl:with-param>
                                        <xsl:with-param name="value">  
                                ...
                                <xsl:otherwise>
                                    <xsl:call-template name="tableRow">
                                        ...
                                        <xsl:with-param name="value">Undetermined</xsl:with-param>
                                    </xsl:call-template>             
                                </xsl:otherwise>
                            </xsl:choose>
                        </xsl:otherwise>
...
<xsl:template match="cml:ion">
    <xsl:call-template name="tableRow">
        ...
        <xsl:with-param name="value">Charge: <xsl:value-of select="@charge"/>
            <xsl:if test="count(@default_erev) &gt; 0">
                &lt;br/&gt;Default reversal potential: <xsl:value-of select="@default_erev"/> <xsl:call-template name="getUnits">
                    <xsl:with-param name="quantity">Voltage</xsl:with-param></xsl:call-template>
            </xsl:if>
            <xsl:if test="count(@role) &gt; 0">
                &lt;br/&gt;Role of ion in process: <xsl:value-of select="@role"/>
            </xsl:if>
            <xsl:if test="count(meta:notes) &gt; 0">
...
<xsl:apply-templates select="meta:neuronDBref"/>
        ...
        <xsl:call-template name="tableRow">
                ...
                <xsl:with-param name="value"><xsl:value-of select="cml:ion_species"/></xsl:with-param>
        </xsl:call-template>
        
        <xsl:for-each select="cml:decaying_pool_model">
            <xsl:call-template name="tableRow">
                <xsl:with-param name="name">  Dynamic model: <xsl:value-of select="name()"/></xsl:with-param>
            </xsl:call-template>
            <xsl:call-template name="tableRow">
                ...
                <xsl:with-param name="value"><xsl:value-of select="cml:resting_conc"/> <xsl:call-template name="getUnits">
            ...
            <xsl:call-template name="tableRow">
                ...
                <xsl:with-param name="value"><xsl:value-of select="cml:decay_constant"/> <xsl:call-template name="getUnits">
            ...
            <xsl:call-template name="tableRow">
                ...
                <xsl:with-param name="value"><xsl:value-of select="cml:pool_volume_info/cml:shell_thickness"/> <xsl:call-template name="getUnits">
                    <xsl:with-param name="quantity">Length</xsl:with-param></xsl:call-template>
                </xsl:with-param>
            </xsl:call-template>
        </xsl:for-each>
    </table>
...
<h3>Synapse: <xsl:value-of select="@name"/></h3>
...
<xsl:template match="cml:doub_exp_syn">
    <xsl:call-template name="tableRow">
        ...
        <xsl:with-param name="value"><xsl:value-of select="@max_conductance"/> <xsl:call-template name="getUnits">
                    <xsl:with-param name="quantity">Conductance</xsl:with-param></xsl:call-template></xsl:with-param>
    </xsl:call-template>
    <xsl:call-template name="tableRow">
        ...
        <xsl:with-param name="value"><xsl:value-of select="@rise_time"/> <xsl:call-template name="getUnits">
                    <xsl:with-param name="quantity">Time</xsl:with-param></xsl:call-template></xsl:with-param>
    </xsl:call-template>
    <xsl:call-template name="tableRow">
        ...
        <xsl:with-param name="value"><xsl:value-of select="@decay_time"/> <xsl:call-template name="getUnits">
                    <xsl:with-param name="quantity">Time</xsl:with-param></xsl:call-template></xsl:with-param>
    </xsl:call-template>
    <xsl:call-template name="tableRow">
        ...
        <xsl:with-param name="value"><xsl:value-of select="@reversal_potential"/> <xsl:call-template name="getUnits">
                    <xsl:with-param name="quantity">Voltage</xsl:with-param></xsl:call-template></xsl:with-param>
    </xsl:call-template>
</xsl:template>
