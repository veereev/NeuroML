...
<!--
    ...
    This file is used to convert ChannelML v1.7 files to GENESIS tabchannel/tab2Dchannel/leakage based script files
...
<xsl:text>// This is a GENESIS script file generated from a ChannelML v1.7 file
