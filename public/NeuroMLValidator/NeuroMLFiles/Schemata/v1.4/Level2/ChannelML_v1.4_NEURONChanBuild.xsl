...
<!--
    ...
    This file is used to convert ChannelML v1.4 files to NEURON KS Channel Builder files
...
<xsl:text>//  This is a NEURON Channel Builder file generated from a ChannelML v1.4 file
//
