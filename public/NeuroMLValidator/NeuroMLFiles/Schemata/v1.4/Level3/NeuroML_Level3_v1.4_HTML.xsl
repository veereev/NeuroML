...
<xsl:stylesheet version="1.0"
    ...
    <xsl:import href="NetworkML_v1.4_HTML.xsl"/>
    <xsl:import href="../Level2/Biophysics_v1.4_HTML.xsl"/>
    <xsl:import href="../Level2/ChannelML_v1.4_HTML.xsl"/>

<!--

    This file is used to convert a Level 3 v1.4 NeuroML files to a "neuroscientist friendly" view
...
<h3>NeuroML v1.4 Level 1 file</h3>
...
<h3>NeuroML v1.4 Level 3 file</h3>
...
<h3>Biophysical properties of cell: <xsl:value-of select="../@name"/></h3>
    ...
    <xsl:call-template name="tableRow">
     ...
     <xsl:apply-templates  select="net:potentialSynapticLocation"/>
