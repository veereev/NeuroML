...
<xsl:stylesheet version="1.0"
    ...
    xmlns:net="http://morphml.org/network/schema"
    ...
    <xsl:import href="NetworkML_v1.3_HTML.xsl"/>
    <xsl:import href="../Level2/Biophysics_v1.3_HTML.xsl"/>
    <xsl:import href="../Level2/ChannelML_v1.3_HTML.xsl"/>

<!--

    This file is used to convert a Level 3 v1.3 NeuroML files to a "neuroscientist friendly" view
...
<h3>NeuroML v1.3 Level 3 file</h3>
...
<xsl:template match="net:populations">mml:segment
</xsl:template>
