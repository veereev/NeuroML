...
<!--
    ...
    This file is used to convert v1.1 ChannelML files to a "neuroscientist friendly" view
...
<!-- Only do the first channel/ion pool -->
...
<table frame="box" rules="all" align="centre" cellpadding="4" width ="100%">
            ...
            <xsl:call-template name="tableRow">
                ...
                <xsl:with-param name="comment">The equations below determine the dynamics of the gating variable <xsl:value-of select="cml:state/@name"/></xsl:with-param>
            </xsl:call-template>
            <xsl:call-template name="tableRow">
                    ...
                    <xsl:call-template name="tableRow">
                        ...
                        <xsl:with-param name="value">
                            &lt;table border="0"&gt;
                                &lt;tr&gt;
                                    &lt;td&gt;
                                        d<xsl:value-of select="../../../cml:state/@name"/>(v,t)
                                    &lt;/td&gt;
                                    &lt;td rowspan="2" valign="center"&gt;
                                        = alpha(v) * (1-<xsl:value-of 
                                select="../../../cml:state/@name"/>) - beta(v) * <xsl:value-of select="../../../cml:state/@name"/>
                                    &lt;/td&gt;                                
                                &lt;/tr&gt;
                                &lt;tr&gt;
