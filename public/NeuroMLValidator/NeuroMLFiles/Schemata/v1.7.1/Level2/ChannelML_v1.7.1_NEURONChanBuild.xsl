...
<!--
    ...
    This file is used to convert ChannelML v1.7.1 files to NEURON KS Channel Builder files
...
<xsl:text>//  This is a NEURON Channel Builder file generated from a ChannelML v1.7.1 file
//
...
{
    // Transition from <xsl:value-of select="@src"/> to <xsl:value-of select="@target"/>
